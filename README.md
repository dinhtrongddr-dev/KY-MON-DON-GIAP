...
Bản 17.5.0 / TG-CB-6.3 (protocol 6) đưa Phase 12–13, `KM-TIMING-3.0`, Niên Mệnh và đợt audit UI/mobile/AI lên production. `KM-CASE-1.0` vẫn đứng sau chuỗi deterministic hiện có: case đã review chỉ hướng dẫn cách lắp luận và kiểm tra guardrail, không đổi Dụng Thần, Structure, Strength, Role, Timing, primary judgment hay Mệnh claims. `verdictOverrideAllowed=false`, `majorityVoteAllowed=false`, `probabilityAllowed=false`; runtime không tự lưu câu hỏi hoặc phiên người dùng làm case. Browser và bridge bắt buộc cùng `caseRules=KM-CASE-1.0`. `KM-SEMANTIC-MATRIX-1.0` tiếp tục là nguồn nghĩa dùng chung; chuỗi AI vẫn ưu tiên GPT-5.6 Sol xhigh, chỉ fallback khi route hiện tại hết hạn mức.
