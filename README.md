...
Bản 16.1.0 / TG-CB-5.1 (protocol 5) hiển thị mã kết nối rõ, cho phép chọn ghi nhớ mã trên trình duyệt và xóa mã đã lưu ngay khi bỏ chọn. Lúc chờ kết nối/luận AI có vòng xoay cùng thời gian đã chờ; trạng thái dọn sạch khi xong, lỗi, hủy hoặc đổi dữ liệu. Giữ nguyên lõi lập bàn; bổ sung kiểm tra văn luận, nguồn/giới hạn quy tắc, đầu vào phương hướng, chữ đậm an toàn, bài ngắn và dữ kiện dự phòng. Astra được đặt `ultra`, mức cao nhất do `model/list` của Codex trên tài khoản hiện tại cung cấp. Báo cáo lượt thử thực và phạm vi nghiệm thu tại `docs/releases/AI-ULTRA-TEST-2026-09-15.md`; kiểm toán yêu cầu tại `docs/releases/AI-REQUIREMENTS-2026-09-15.md`.
