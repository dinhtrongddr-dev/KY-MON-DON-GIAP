...
Bản 17.3.0 / TG-CB-6.3 (protocol 5) tích hợp `KM-SEMANTIC-MATRIX-1.0` làm nguồn nghĩa dùng chung cho Kỳ Môn Hỏi Việc và Kỳ Môn Mệnh. Matrix chỉ dịch Cung–Môn–Tinh–Thần–Can sau khi lớp Dụng Thần/chủ thể đã được xác định, áp từ vựng theo domain và state modifier mà không đổi core/resolver. Writer chỉ được tô đậm câu dịch nghĩa tự nhiên, không tô đậm căn cứ kỹ thuật. Chuỗi AI vẫn ưu tiên GPT-5.6 Sol xhigh; chỉ fallback sang Gemini rồi Prism khi model hiện tại báo hết hạn mức, còn lỗi validation được sửa lại trên cùng model và ghi log kỹ thuật.
