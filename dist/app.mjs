...
const floatBoard = document.querySelector('#float-board');
...
floatBoard?.addEventListener('click',()=>document.querySelector('.board-column')?.scrollIntoView({behavior:'smooth',block:'start'}));
