export function buildWriterContext(context) {
  ...
  const readingGraph={schemaVersion:g.schemaVersion,
    ...
    rules:g.rules,likelyScenario:g.likelyScenario,recommendations:g.recommendations,unresolved:g.unresolved,coverage:g.coverage};
  ...
  return {rules:context.rules,question:context.question,topic_id:c.resolvedTopic,mode:c.classification.mode,questionType:q.questionType,
    ...
    length:{depth:q.depth,target:q.depth==='deep'?'900–1400':concise?'120–300':simple?'ngắn gọn theo độ phức tạp':'500–800',
      minWords:concise?40:q.depth==='deep'?350:simple?180:300,maxWords:q.depth==='deep'?1600:800,
