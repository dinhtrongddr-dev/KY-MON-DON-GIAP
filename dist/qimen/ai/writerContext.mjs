...
export function buildWriterContext(context) {
  ...
  const readingGraph={schemaVersion:g.schemaVersion,
    ...
    mode:g.mode,usefulGodProfile:g.usefulGodProfile,structureProfile:g.structureProfile,nodes:g.nodes.filter(n=>actors.has(n.id)||n.status==='unresolved').map(n=>({id:n.id,actorId:n.actorId,role:n.semanticRole,source:n.source,evidenceIds:n.evidenceIds,relevance:n.relevance,confidenceLevel:n.confidenceLevel,palace:n.palace,stem:n.stem||null,status:n.status,
    ...
    evidenceBundles:g.evidenceBundles.map(b=>({id:b.id,palace:b.palace,actorIds:b.actorIds,roles:b.roles,symbols:b.symbols,strength:b.strength,states:b.states,fourHarms:b.fourHarms,
