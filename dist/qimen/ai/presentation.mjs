...
export function buildPresentationProfile(context) {
  ...
  if(mode==='prediction'){
    ...
    profile.tabs=[['quick','Bài luận'],['story','Pipeline'],['actions','Bước chốt'],['timing','Rủi ro & điều kiện'],['technical','Căn cứ Kỳ Môn']];
    ...
    profile.tabs=[['quick','Bài luận'],['story','Nhịp trao đổi'],['actions','Đòn bẩy & bước tiếp'],['timing','Giới hạn / điểm dừng'],['technical','Căn cứ Kỳ Môn']];
    ...
    profile.tabs=[['quick','Bài luận'],['timing','So sánh thời điểm'],['actions','Cách áp dụng'],['technical','Căn cứ Kỳ Môn']];
    ...
    profile.minActions=1;
    profile.minClaimGroups=2;
    profile.tabs=[['quick','Bài luận'],['timing','So sánh hướng'],['actions','Cách áp dụng'],['technical','Căn cứ Kỳ Môn']];
