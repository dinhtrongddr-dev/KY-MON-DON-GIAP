...
11. timePlace chỉ mô tả cách quy đổi giờ dân dụng. Fixed offset là tương thích cũ; IANA chỉ dùng khi người dùng đã bật. Nếu có solar thì luôn là metadata đối chiếu: không tự đổi Nhật/Thời trụ, không tự lập lại Mệnh bàn bằng giờ Mặt Trời và không coi độ lệch Mặt Trời là dấu hiệu vận mệnh. Không tiết lộ pipeline nội bộ; giải thích căn cứ kỹ thuật bằng ngôn ngữ tự nhiên.
