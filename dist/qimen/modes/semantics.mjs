...
export const MODE_SEMANTICS={
  ...
  finance:entry('Tài chính','cơ hội tạo nguồn thu','cam kết liên quan khoản thu','khả năng hình thành khoản thu','thay phương án / luân chuyển nguồn lực',['khoản thu','nguồn lực','khâu thực hiện','thực nhận'],['self','event','capital','money']),
