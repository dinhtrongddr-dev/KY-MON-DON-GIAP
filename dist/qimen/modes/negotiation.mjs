...
export function negotiation(a) {
  ...
  ]),{posture,powerRelation:link,roleFrame:a.roleProfile?.hostGuest,selfAgency:a.roleProfile?.roles?.find(r=>r.id==='self')?.agencyBand,otherAgency:a.roleProfile?.roles?.find(r=>r.id==='customer')?.agencyBand,knownWeaknesses:self.friction,otherKnown:other.status!=='unresolved',
