...
| KM-FORMATION-3.0 | Qimen Fa Qiao-profile Three Deceptions (3), Five Fakes (5, including Earth-Fake Nine-Earth/Tai-Yin/Six-Harmony subvariants), Nine Escapes (9); Wonder-tomb/Punishment/Door-pressure qualification; Heaven Three Gates from middle-qi month-general overlay; Earth Four Doors from Jian-Chu offsets; modern action tags and direction annotations; `KM-UI-ATTENTION-1.0` presentation badges for strong support/warning/conflict | Strategic/action layer only: no evidence-score weight, no primary-judgment override, no timing/direction rank override, no safety/success guarantee. Attention UI has no numeric score/probability and does not use Seven Stars Path. Five-Fake rows using Ji/Gui/Ren remain `partial_tomb_coverage` until non-Three-Wonder tomb rules exist. Variant traditions are provenance metadata rather than extra votes. |
