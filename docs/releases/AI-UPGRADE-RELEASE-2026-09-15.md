...
| Kiểm tra dữ kiện trong văn | `technicalAudit.mjs` kiểm các mẫu vị trí Môn/Tinh/Thần/Can, Không/Mã/Môn bức, hình/mộ từng can, vai, chiều sinh/khắc và rule/claim/evidence. Ca “Sinh Môn nằm ở cung 5” đã bị chặn dù ID hợp lệ; Càn/Cấn được phân biệt trước khi bỏ dấu. | Bộ kiểm tra mẫu câu không chứng minh toàn bộ ngữ nghĩa tự do; còn có cách nói vòng chưa bao phủ. |
...
- `npm run check`: **126 Node tests + 1 Python test đạt**. Kiểm 63 tài nguyên, 127 tham chiếu nội bộ, cú pháp/NFC và sáu tệp lõi đạt.
