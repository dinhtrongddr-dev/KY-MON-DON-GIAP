...
export function createBridge({token=defaultPairingToken(),port=8765,runner=runAI,activityStore=createActivityStore(),outcomeRegistry=createOutcomeRegistry(),keepAliveAfterMs=75000,keepAliveEveryMs=15000,tunnelHostname=configuredTunnelHostname(),shareDir=defaultShareDir()}={}){
 ...
 const files=new Set(['/index.html','/menh.html','/guide.html','/server.html','/info.html','/audit.html','/styles.css','/app.mjs','/menh-app.mjs','/menh-ai.mjs','/menh-view.mjs','/activity-log.mjs','/guide.mjs','/info.mjs','/qimen.mjs','/ai-local.mjs','/report-export.mjs','/question-report.mjs','/share-view.mjs','/reading-core.mjs','/reading-job-client.mjs','/menh-reading-core.mjs','/menh-core.mjs','/reading-focus.mjs','/reading-view.mjs','/favicon.svg','/favicon-32.png','/apple-touch-icon.png','/assets/taiji-ink.png','/vendor/lunar.js','/vendor/LICENSE.lunar-javascript']);
